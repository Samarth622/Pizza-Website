...
function Footer() {
  ...
  return (
    <>
      <section className={`${darkMode ? 'dark bg-gray-900' : 'light bg-black'} w-full h-fit lg:px-20 px-10 lg:py-20 py-10 flex flex-col justify-center items-center gap-6`}>
        <h1 className="text-white font-bold text-5xl">
          Pizzazz <span className="text-orange-500 italic">Pies</span>
        </h1>
        <p className="text-xl text-slate-100 text-center">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Dolorum nobis nisi, recusandae in sit saepe ullam dolorem sapiente!</p>
